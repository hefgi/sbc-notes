...
contract HealthRecord {
	...
	function createRecord(string _problems, string _medications, string _allergies, uint _weight_kg, uint _height_cm) external {
	...
	function getRecord(address _address) view external returns (string _problems, string _medications, string _allergies, uint _weight_kg, uint _height_cm) {
		Record memory rec = records[_address];

		return (rec.problems, rec.medications, rec.allergies, rec.weight_kg, rec.height_cm);
	}

	function updateRecord(address _address, string _problems, string _medications, string _allergies, uint _weight_kg, uint _height_cm) external {
